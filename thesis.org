...
#+ATTR_LATEX: :width \textwidth
#+CAPTION: Tiling and unrolling access patterns
[[file:./img/blocking_unrolling.pdf]]

#+CAPTION: Test
#+begin_src C :results output :exports code :eval no-export
int N = 256;
int BLOCK = 4;
