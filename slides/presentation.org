...
Climate  simulation  for policies to fight *climate change*
...
** Now, it is Harder to Improve Hardware, but Autotuning can Help!
...
Performance as a *function*: $f: \mathcal{X} \to \mathbb{R}$
...
#+ATTR_LATEX: :width \textwidth
[[file:../img/search_spaces_annotated.pdf]]
...
*** Search Space Dimension                                  :B_block:BMCOL:
:PROPERTIES:
:BEAMER_col: 0.5
:BEAMER_env: block
:END:
...
*** Some Autotuning Methods                                 :B_block:BMCOL:
:PROPERTIES:
:BEAMER_col: 0.5
:BEAMER_env: block
:END:
