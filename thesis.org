...
factors\nbsp{}\cite{plackett1946design}.    We   present    an   algorithm   for
constructing  such designs  in Section\nbsp{}\ref{sec:paley}.  The final  design
matrix also contains a column for  the computed response, subject to measurement
error.
...
Term & Sum of Squares & F-value & $\text{p}(>\text{F})$ & ``\textit{Significance}'' \\
  \midrule
x1 & 2.784 & 35.914 & 0.009 & $**$ \\
  x2 & 0.216 & 2.790 & 0.193 &   \\
  x3 & 38.896 & 501.798 & 0.000 & $***$ \\
  x4 & 0.749 & 9.669 & 0.053 & $\cdot$ \\
  x5 & 25.353 & 327.077 & 0.000 & $***$ \\
  x6 & 0.995 & 12.832 & 0.037 & $*$ \\
  x7 & 4.929 & 63.592 & 0.004 & $**$ \\
  x8 & 43.838 & 565.548 & 0.000 & $***$ \\
   \bottomrule
\end{tabular}
\endgroup
\end{table}
...
**** Plackett-Burman Designs using the Paley Construction of Hadamard Matrices
:PROPERTIES:
:CUSTOM_ID: sec:paley
:END:
