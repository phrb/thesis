...
#+ATTR_LATEX: :align p{.22\columnwidth}p{.2\columnwidth}p{.5\columnwidth} :booktabs t :placement []\scriptsize
|--------------------------------------------------------------------------+---------------------------------+-------------------------------------------------------------------|
...
| $\theta: X \mapsto \Theta$                                               | Parameter vector                | Estimate of the coefficients of a linear model                    |
