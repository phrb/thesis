...
#+NAME: fig:org-thesis
#+ATTR_LATEX: :width .73\textwidth :placement [t]
...
We  have  produced  a  paper  and  presentations  using  this  workflow,  but  a
fundamental part of our day-to-day work included a /laboratory journal/. Keeping
a  journal enabled  tracking discussions  and meetings,  annotating and  linking
papers, and testing ideas with code  snippets. Entire chapters and many sections
in this thesis were adapted or directly reproduced from our journal.
...
#+ATTR_LATEX: :align rll :booktabs t
|----------------+-------------------------------------------------------+---------------------------------------|
| Project        | Archive                                               | Thesis Chapter                        |
|----------------+-------------------------------------------------------+---------------------------------------|
| Thesis journal | \cite{bruel2021phd-journal}                           | \ref{chap:method}                     |
| CCPE paper     | \cite{bruel2021gpu-autotuning}                        | \ref{chap:cuda}                       |
| ReConFig paper | \cite{bruel2021legup-tuner,bruel2021legup-dockerfile} | \ref{chap:fpga}                       |
| CCGRID paper   | \cite{bruel2021ccgrid19,bruel2021dlmt,bruel2021dopt}  | \ref{chap:laplacian},\ref{chap:spapt} |
