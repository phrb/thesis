...
#+LATEX_HEADER:   textwidth=150mm, % 210-24-34
#+LATEX_HEADER:   textheight=240mm, % 297-32-28
...
#+LATEX_HEADER: \fancyfoot[RE,LO]{\thepage}
...
in Chapter\nbsp{}[[Stochastic Methods and Experimental Design for a
...
and Experimental  Design for a  Laplacian GPU  Kernel]], and on  larger autotuning
problem  on  the  quantization  of   /Deep  Neural  Network/  (DNN)  layers,  in
Chapter\nbsp{}[[Gaussian Process Regression for Neural Network Bit Quantization]].
...
optimizations /opt-level/ equal to /0/, /1/,  /2/, and /3/ are denoted by /-O0/,
/-O1/,  /-O2/, and  /-O3/.  The  results  for the  autotuned configurations  are
denoted by the keyword /Tuned/.
...
Optimal  Design  methods we  discuss  in  Chapters\nbsp{}[[Stochastic Methods  and
Experimental  Design for  a Laplacian  GPU  Kernel]] and  [[Experimental Design  and
Gaussian Process Regression for CPU Kernels]].

** Stochastic Methods and Experimental Design for a Laplacian GPU Kernel
