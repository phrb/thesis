...
- The more *rigid* model performed better
...
:END:
\vspace{1.1em}
**** \textcolor{OliveGreen}{Gaussian Processes}
...
\begin{center}
  ...
  Exhaustive and collective experiments  are \alert{interdependent} and can help
  achieve \alert{reproducible autotuning}
  \end{tcolorbox}
\end{center}
#+end_export
