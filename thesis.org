...
Chapter\nbsp{}[[Search Heuristics and Statistical  Learning]] provides more detailed
...
well-established statistics,  although their usage is  not common in, nor  is it
standardized for, autotuning domains.

The first  contribution of  this thesis  is a  strategy to  apply the  Design of
...
*** Space-Filling Designs for Quantization of DNN Layers
** Optimal Design
*** Optimality Criteria
*** Exchange Algorithms for Optimal Design Construction
** Prediction and Inference for HPC Kernels
*** Results with SPAPT Kernels
* Autotuning for Larger Search Spaces with Gaussian Process Regression
** Introduction
