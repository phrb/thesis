...
to reignite our strength to continue.
...
$R$, we  optimize a function $Q:  S\times{}A \to \mathbb{R}$, in  a method named
...
recurrence  function  and filling  a  table  of  rewards for  each  state-action
