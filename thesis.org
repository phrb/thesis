...
:  $ name                   : chr  "atax" "dgemv" "fdtd4d2d" "gemver" ...
...
#+begin_SRC R :results graphics output :session *R* :file "./img/search_spaces.pdf" :width 18 :height 7 :eval no-export
library(ggplot2)
library(dplyr)
library(scales)
...
p1 <- ggplot(data = df_search_spaces,
    ...
    geom_text_repel(data = filter(df_search_spaces,
                    ...
                    show.legend = FALSE) +
    xlab("Dimension") +
    ylab("Estimated Search Space Size") +
    ...
    scale_shape_manual(name = element_blank(),
                       values = c(15, 16, 17, 18, 6, 7, 9, 0, 3, 5)) +
    scale_y_continuous(label = scientific_10) +
    theme_bw(base_size = base_size) +
    theme(legend.position = c(0.255, 0.89),
          legend.direction = "horizontal",
